  ...
  const purchaseTabsLink = purchaseTabs.map((tab) => (
    <Link
      ...
      className={classNames('flex flex-1 items-center justify-center border-b-2 bg-white py-4 text-center', {
        'border-b-orangeShopee': status === tab.status,
              ...
              <div className='mt-4 rounded-sm border-black/10 bg-white p-6 text-gray-800 shadow-sm' key={purchase._id}>
                ...
                >
                  ...
                  <div className='ml-3 flex-shrink-0'>
                    ...
                    <span className='truncate text-orangeShopee ml-2'>₫{formatCurrency(purchase.product.price)}</span>
                  </div>
                </Link>
                <div className='flex justify-end'>
                  <div className=''>
                    <span>Tổng giá tiền:</span>
                    <span className='ml-4 text-xl text-orangeShopee'>
